export const translations = {
  uz: {
    ...
    about: {
      ...
      vision: "Bizning yondashuvimiz",
      visionText:
        "O'zbekistonda eng ilg'or va innovatsion soliq xizmatlari provayderiga aylanish, raqamli texnologiyalar va zamonaviy yondashuvlarni qo'llash orqali mijozlarimizga eng yaxshi xizmatni taqdim etish.",
    ...
    news: {
      ...
      subtitle: "Soliq bo'yicha tegishli yangiliklar",
      subtitle_blog: "Soliq bo'yicha tegishli ma'lumotlar",
      readMore: "Batafsil",
      showMore: "Ko'proq",
    ...
    contact: {
      ...
      phone2: "Telefon",
      phoneValue: "+998 94 754-00-70",
      email2: "Email",
      emailValue: "azimovsaidumar@gmail.com",
  ...
  ru: {
    ...
    services: {
      title: "Наши услуги",
      serv1: "Налоговые консультации",
      serv2: "Бухгалтерские услуги",
      serv3: "Проблемы с Соликом",
      serv4: "Налоговый аудит и ликвидация",
      serv5: "Банкротство",
    ...
    about: {
      ...
      description:
        "С 19-летним опытом работы в налоговой сфере, мы помогли тысячам компаний выполнить налоговые обязательства и достичь финансовых целей.",
      sub_desc: "Наши основные принципы",
      mission: "Наша миссия",
      missionText:
    ...
    news: {
      ...
      subtitle: "Актуальные новости по налогам",
      subtitle_blog: "Актуальная информация по налогам",
  ...
  en: {
    ...
    services: {
      title: "Our Services",
      serv1: "Tax Consulting",
      serv2: "Accounting Services",
      serv3: "Tax Problems",
      serv4: "Tax Audit & Liquidation",
      serv5: "Bankruptcy",
    ...
    about: {
      ...
      description:
        "With 19 years of experience in taxation, we have helped thousands of companies meet their tax obligations and achieve their financial goals.",
      sub_desc: "Our core principles",
      mission: "Our Mission",
      missionText:
    ...
    news: {
      title: "Latest News",
      subtitle: "Relevant tax news",
      subtitle_blog: "Relevant tax information",
      readMore: "Read More",
      showMore: "Show More",
